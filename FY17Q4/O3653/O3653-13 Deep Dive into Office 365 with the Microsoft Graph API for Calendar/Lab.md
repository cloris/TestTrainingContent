...
1. This exercise is based on the project located in the  [\\O3653\O3653-13 Deep Dive into Office 365 with the Microsoft Graph API for Calendar\Starter Project](Starter Project) folder. Open the project with Visual Studio 2017. 
   ...
   Notice: update web.config and add values for below items.  
...
2. Update **_Layout** file to add **Outlook Calendar API** link:
...
1. Add a reference to the Microsoft Graph SDK to your project.
   ...
   2. Change **Package Source** (on the upper right corner) to **Microsoft Graph local**.
   3. Click **Browse** and search for **Microsoft.Graph**.
   4. Select the Microsoft Graph SDK and click **Install**.
